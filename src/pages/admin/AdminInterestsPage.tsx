...
export function AdminInterestsPage() {
  ...
  const form = useForm<FormData>({ resolver: zodResolver(schema), defaultValues: { clientId: "", destination: "", startDate: "", endDate: "", details: "", status: "waiting", priority: "normal", publicVisible: true } });
