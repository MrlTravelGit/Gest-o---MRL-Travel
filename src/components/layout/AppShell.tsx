...
import { BarChart3, BellRing, Calculator, CalendarRange, ClipboardList, CreditCard, DatabaseZap, FileInput, FileText, Gem, History, KeyRound, ListChecks, LogOut, MapPinned, Menu, PlaneTakeoff, Send, ShieldCheck, UserPlus, Users, WalletCards, X } from "lucide-react";
...
const navItems = [
  ...
  { label: "Programas", to: "/admin/programas", icon: WalletCards },
  { label: "Vigências", to: "/admin/vigencias", icon: CalendarRange },
