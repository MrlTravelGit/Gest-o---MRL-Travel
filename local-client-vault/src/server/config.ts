...
if (host !== "0.0.0.0" && host !== "127.0.0.1" && !isPrivateIpv4(host)) throw new Error("VAULT_BIND_HOST deve ser 0.0.0.0, loopback de desenvolvimento ou IPv4 privado.");
const parsedPublicUrl = new URL(publicUrl);
if (parsedPublicUrl.protocol !== "http:") throw new Error("VAULT_PUBLIC_URL deve usar HTTP na rede local.");
export const config = {
  ...
  allowedOrigins: ["http://127.0.0.1:7443","http://localhost:7443","http://192.168.0.25:7443"],
