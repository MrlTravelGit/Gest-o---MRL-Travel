...
select has_function('public','get_client_management_terms_v1',array['text','text','text','date','date','date','date','boolean','boolean','numeric','numeric','numeric','numeric','text','text','integer','integer'],'RPC de vigencias existe');
